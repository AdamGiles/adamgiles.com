...
var twitter_username = 'MrAdamGiles';
...
"use strict";
	...
	jQuery('.home_bg4').parallax("40%", 0.3); // Backgrounds	banner style3
	jQuery('.home_bg5').parallax("40%", 0.3); // Backgrounds	banner style3
	...
	function loadVegas(){
		$.vegas('slideshow', {
			  backgrounds:[
				...
				{ src:'./assets/images/slider/04_b.jpg', fade:1000 },
				{ src:'./assets/images/slider/05_b.jpg', fade:1000 },
			  ]
			})('overlay', {
